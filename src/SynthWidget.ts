...
SynthWidget.prototype.addListener = function (listener, listenerThisArg) {
...
SynthWidget.prototype.onPlay = function (keyListener, keyListenerThisArg) {
...
SynthWidget.prototype.node = function () {
  if (!this._containerNode) {
    ...
    [
      ...
      110.0, 116.54, 123.47, 130.81, 138.59, 146.83, 155.56, 164.81, 174.61,
      ...
      880.0, 932.33, 987.77, 1046.5, 1108.73, 1174.66, 1244.51, 1318.51,
      1396.91, 1479.98, 1567.98, 1661.22, 1760.0, 1864.66, 1975.53, 2093.0,
      2217.46, 2349.32, 2489.02, 2637.02, 2793.83, 2959.96, 3135.96, 3322.44,
      ...
      if (i % 12 == 0) {
        ...
        if (i == 0) {
          key.parentNode().setNodeAlignmentMode(DOWNWARD, ALIGN_CENTER);
        }
        car.push();
      } else {
